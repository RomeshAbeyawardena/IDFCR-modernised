    ...
    where TResult : IQueuePullResult<TMessageItem, TBody>
{
    ...
    Task<IUnitResultCollection<TMessageItem>> PullMessagesAsync(
    ...
    Task<IUnitResult> AcknowledgeMessageAsync(string messageId, CancellationToken cancellationToken);
}
