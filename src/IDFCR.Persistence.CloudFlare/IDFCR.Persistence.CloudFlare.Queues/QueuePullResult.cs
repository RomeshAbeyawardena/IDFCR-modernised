...
/// </summary>
public class QueuePullResult 
    : IQueuePullResult<QueueMessageItem, JsonElement>
{
    IEnumerable<QueueMessageItem> IQueuePullResult<QueueMessageItem, JsonElement>.Messages => Messages;
    ...
    public List<QueueMessageItem> Messages { get; set; } = new();
}
